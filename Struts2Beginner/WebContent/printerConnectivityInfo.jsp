  ...
  <div class="row container" style="padding-left:200px" id="main">
    <br>
     <form action="snmpDisabledSwitch.action" method="get">
			...
			<thead>
					<tr>
					<td>Printer- Connectivity Details</td>
					<tr>
			</thead>
			<tbody>
					<s:iterator value="listOfSwitchDetails">
					<td><s:url action="nodeConnectivityInformation" id="nodeConnectivityInfo">
					<s:param name="deviceIPAddress" value="computerIPAddress"/></s:url>
					<s:a href="%{nodeConnectivityInfo}" ><font color= "#0f3252"><s:property value="computerIPAddress"/></s:a>
					<br></td>
					</tr>
					</s:iterator>
			</tbody>		
