...
<body>
  ...
  <ul id="slide-out" class="side-nav fixed grey lighten-2" style="padding-top:75px">
      <li><a href ="userSwitchInfo.jsp"><font size=3px>Switch Information</font></a></li>
           ...
           <li class="orange"><a class="white-text" href="userConnectivityOfNode.jsp"><font size=3px>Network Node Connectivity</span></a></li>
  ...
  <div class="row container" style="padding-left:200px" id="main">
     <br>
     <h5>Hello User</h5>
			<p>This section provides you the connectivity details of a node</p> 
      			<form action="nodeConnectivityInformation.action" method="get">
			<p>Please enter the IP Address of any node</p>
           	<h6>NODE IP ADDRESS</h6>
			<input type="text" id="deviceIPAddress" name="deviceIPAddress" class="deviceIPAddress" />	
			 <input class="btn light-blue" type="submit" name="submit" value="Submit" onclick="ValidateIPaddress(deviceIPAddress)"/>
