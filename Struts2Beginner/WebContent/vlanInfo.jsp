...
<body>
  ...
  <ul id="slide-out" class="side-nav fixed grey lighten-2" style="padding-top:75px">
      <li><a href ="userSwitchInfo.jsp"><font size=3px>Switch Information</font></a></li>
           ...
           <li> <a href="userConnectivityOfNode.jsp"><font size=3px>Network Node Connectivity</span></a></li>
			...
			<li class="orange"><s:a href="%{vlanInfo}" ><font size=3px style="color:white">VLAN Information</font></span></s:a></li>
  ...
  <div class="row container" style="padding-left:200px" id="main">
    <br>
     <form action="vlanInformation.action" method="get">
			...
			<table class="striped centered">
					...
					<s:url action="eachVlanConnectedInformation" id="vlanConnectedInfo">
					<s:param name="vlanId" value="vlanId"/></s:url>
					<s:a href="%{vlanConnectedInfo}" ><font color= "#0f3252"><s:property value="vlanId"/></s:a><br></td>

					
					
					<td><s:property value="vlanName"/><br></td>
					</tr>
					</s:iterator>
