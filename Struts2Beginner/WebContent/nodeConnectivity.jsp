  ...
  <div class="row container" style="padding-left:200px" id="main">
			...
			<table class="striped centered">
					...
					<tr>
						...
						<td >Port Number</td>
						<td>Port Type In Switch</td>
						<td >Vlan Id</td>
					</tr>
					</thead>
					<tbody>
					<tr>
					<s:iterator value="listOfNodeDetails">
					<td><s:property value="deviceIPAddress"/></td>
					<td><s:property value="deviceMACAddress"/></td>
					<td>
					<s:url action="userSwitchInformation" id="switchInfo">
					<s:param name="switchIPAddress" value="switchIPAddress"/></s:url>
					<s:a href="%{switchInfo}" ><font color= "#0f3252"><s:property value="switchIPAddress"/></s:a></td>
					
					
					<td>
					
					<s:url action="portOneInformation" id="onePortInfo">
					<s:param name="portNum" value="portNum"/>
					<s:param name="switchIPAddress" value="switchIPAddress"/></s:url>
					<s:a href="%{onePortInfo}" ><font color= "#0f3252"><s:property value="portNum"/></s:a></td>
					
					<td><s:property value="portTypeInSwitch"/></td>
