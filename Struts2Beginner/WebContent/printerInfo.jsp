  ...
  <ul id="slide-out" class="side-nav fixed grey lighten-2" style="padding-top:75px">
      <li><a href ="userSwitchInfo.jsp"><font size=3px>Switch Information</font></a></li>
           ...
           <li> <a href="userConnectivityOfNode.jsp"><font size=3px>Network Node Connectivity</span></a></li>
			...
			<li class="orange"><s:a href="%{printerInfo}" ><font size=3px style="color:white">Printer list</font></span></s:a></li>
  </ul>  
  <div class="row container" style="padding-left:200px" id="main">
    <br>
    <form action="snmpDisabledSwitch.action" method="get">
			...
			<tbody>
					...
					<td>
					<s:url action="printerConnectivityInformation" id="printerConnectivityInfo">
					<s:param name="printerIPAddress" value="printerIPAddress"/></s:url>
					<s:a href="%{printerConnectivityInfo}" ><font color= "#0f3252"><s:property value="printerIPAddress"/></s:a>
					<br></td>
					<td>
					<s:property value="printerName"/>
					<br></td>
					</tr>
					</s:iterator>
				</tbody>	
