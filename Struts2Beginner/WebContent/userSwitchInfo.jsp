...
<body>
  ...
  <div class="row container" style="padding-left:200px" id="main">
    <br>
    <h5>Hello User</h5>
			<p>This section provides you the information of the switch</p>  
    <form action="userSwitchInformation.action" method="get">
			...
			<input type="text" id="switchIPAddress" name="switchIPAddress" class="switchIPAddress" />	
			 <input class="btn light-blue" type="submit" name="submit" value="Submit" onclick="ValidateIPaddress(switchIPAddress)"/>
			 </form>
  </div>
