...
<body>
  ...
  <ul id="slide-out" class="side-nav fixed grey lighten-2" style="padding-top:75px">
      <li class="orange"><a class="white-text" href ="userSwitchInfo.jsp"><font size=3px>Switch Information</font></a></li>
  ...
  <div class="row container" style="padding-left:200px" id="main">
    <br>
    <CENTER><h5>SWITCH IP ADDRESS :</h5> </CENTER>
			<s:url action="userSwitchInformation" id="switchInfo">
			<s:param name="switchIPAddress" value="switchIPAddress"/></s:url>
			<CENTER><h3><s:a href="%{switchInfo}" ><font color= "#0f3252"><s:property value="switchIPAddress"/></s:a></h3></CENTER>
		<br></br>
			<form action="portInformation.action" method="get">
			...
			<table>
				<tr>
					...
					<!--	<td>Switch Reset Date and Time</td>-->
					</tr>
					<tr>
						<s:iterator value="listOfSwitchDetails">
						<td><s:property value="switchIPAddress"/></td>
						<td><s:property value="switchMACAddress"/></td>
						<td><s:property value="switchName"/></td>
						<td><s:property value="numOfPorts"/></td>
						<td><s:property value="location"/></td>
						<td><s:property value="contactPerson"/></td>
						<!--<td><s:property value="resetDateTime"/></td>-->
						</s:iterator>
					</tr>
