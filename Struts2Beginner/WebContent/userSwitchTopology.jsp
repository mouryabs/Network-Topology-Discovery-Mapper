...
<body>
  ...
  <ul id="slide-out" class="side-nav fixed grey lighten-2" style="padding-top:75px">
      <li><a href ="userSwitchInfo.jsp"><font size=3px>Switch Information</font></a></li>
           ...
           <li class="orange"><a class="white-text" href="userSwitchTopology.jsp"><font size=3px>Switch Topology</span></a></li>
  ...
  <br>
    <h5>Hello User</h5>
			<p>This section provides you the diagrammatic representation of the topology of the switch</p>
    <form action="chart.action" method="post">
			...
			<input type="text" id="switchIPAddress" name="switchIPAddress" class="switchIPAddress" />	
			 <input class="btn light-blue" type="submit" name="submit" value="Submit" onclick="ValidateIPaddress(switchIPAddress)"/></form>
  </div>
...
function ValidateIPaddress(inputText)  
 ...
 {  
 document.chart.action.switchIPAddress.focus();  
 return true;  
 }  
 else  
 {  
